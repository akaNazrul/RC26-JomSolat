    ...
    <div className="min-h-screen bg-bg-base">
      ...
      <div className="p-4 space-y-6">
        ...
        <div className="flex justify-center gap-4">
          <a href="https://www.facebook.com/PusatIslamUSM" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-bg-surface border border-border-color hover:bg-bg-elevated">
          ...
          <a href="https://www.instagram.com/pusatislam.usm" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-bg-surface border border-border-color hover:bg-bg-elevated">
